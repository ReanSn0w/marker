...
func Push(key Key, val Value) view.Modificator {
	return func(v view.View) view.View {
		return view.Closure(func(ctx context.Context) view.View {
			value := ctx.Value(attrCtxKey)
			attr, ok := value.(attributes)
...
func Delete(key Key) view.Modificator {
	return func(v view.View) view.View {
		return view.Closure(func(ctx context.Context) view.View {
			value := ctx.Value(attrCtxKey)
			attr, ok := value.(attributes)
...
func WithStyle(selector string, dec Declarations) view.Modificator {
...
func WithRuleStyle(rule string, sel string, dec Declarations) view.Modificator {
	return func(v view.View) view.View {
		return view.Closure(func(ctx context.Context) view.View {
			style := getStyle(ctx)
			class := getClass(ctx)
			...
			return view.NewModificationApplyer(v)(
				Class(string(class)),
			)
		})
	}
